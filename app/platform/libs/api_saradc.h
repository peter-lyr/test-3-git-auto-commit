...
#define ADCCH15_ANA_BG      0x01
#define ADCCH15_ANA_VRTC    0x02        //实际测量VDDCORE电压
#define ADCCH15_ANA_MIC     0x04
#define ADCCH15_ANA_TS      0x08
...
#define saradc_kick_start(auto_anl_en)  saradc_kick_start_do(saradc_cb.channel, auto_anl_en)
...
void saradc_kick_start_do(u16 adc_ch, u8 auto_anl_en);          //启动ADC转换
