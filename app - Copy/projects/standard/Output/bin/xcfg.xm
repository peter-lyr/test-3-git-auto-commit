...
config(LISTVAL, "DAC最大音量", "配置DAC最大输出幅度", DAC_MAX_GAIN, BIT, 4, 1, 16, ("+6DB", 0), ("+5DB", 1), ("+4DB", 2), ("+3DB", 3), ("+2DB", 4), ("+1DB", 5), ("0DB", 6), ("-1DB", 7), ("-2DB", 8), ("-3DB", 9), ("-4DB", 10), ("-5DB", 11), ("-6DB", 12), ("-7DB", 13), ("-8DB", 14), ("-9DB", 15));
