 ...
 *****************************************************************************/
#define FUNC_MUSIC_EN                   0                       //是否打开SD/UDISK音乐播放功能
#define FUNC_CLOCK_EN                   0                       //是否打开时钟功能
#define FUNC_SPEAKER_EN                 1                       //是否打开SPEAKER功能
...
#define POWER_OFF_IO                    IO_PA0                  //关机IO设置(用于避免按键未松开就进行关机流程,实际关机接口func_pwroff)
...
#define IMA_ADPCM_DEC_EN                0       //是否使能IMA ADPCM格式的wav文件解码(使用wav_song_play/wav_res_play)
...
#define REC_INTERNAL_FLASH              1   //是否录入内置flash，  录入外置flash需要开启外置flash播放(EXSPI_MUSIC | EXSPI_REC)
#define REC_FAST_PLAY_INTERNAL          1   // 快速播放最新的录音文件（内置flash）
#define REC_VOICE_CHANGER_EN            0   //录变音功能使能
...
* Module    : AUX功能配置
******************************************************************************/
#define AUX_CHANNEL_CFG                 CH_AUX_PA14     //选择LINEIN通路
...
#define SPIFLASH_MAP                    SPI1MAP_G2      //SPI CLK/DI/DO IO 选用G2防止与SD UDISK冲突
#define SPIFLASH_CS_IO                  IO_PA1          //SPI CS IO
...
#define EXSPI_VSBC_EN                   0               //是否支持exspiflash vsbc音频播放
...
#define SD0_DET_GPIO_SEL                IO_PA7      //复用检测时可以选IO_MUX_SDCLK
...
#define PWM_TMR2_1KHZ_TEST_EN           0                                   //TMR2PWM输出1K hz测试
