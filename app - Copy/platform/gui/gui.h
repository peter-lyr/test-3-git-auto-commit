...
#elif (GUI_SELECT & DISPLAY_LCDSEG)
#include "lcd/lcd_4c16s_3b.h"
#define gui_scan()                  lcd_4c16s_scan()
#define gui_display_test()          lcd_4c16s_dis_test()
#else
#define gui_scan()
#define gui_display(n)
#define gui_off()
#define gui_display_test()
#endif
